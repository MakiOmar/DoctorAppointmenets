<template>
  <div>
    ...
    <div v-else-if="error" class="text-center py-12">
      ...
      <button @click="loadCertificates" class="bg-white text-primary-500 px-4 py-2 rounded-lg hover:bg-gray-100">
        {{ $t('common.retry') }}
      </button>
    </div>
    ...
    <div v-else class="text-center py-12">
      ...
      <h3 class="text-lg text-white mb-2">{{ $t('therapistDetails.noCertificates') }}</h3>
