    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="therapist" class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <div class="card">
            <h1 class="text-2xl text-gray-900 mb-6">Book Your Session</h1>
        ...
        <div class="lg:col-span-1">
          <div class="card sticky top-8">
            <h2 class="text-xl text-gray-900 mb-4">Booking Summary</h2>
      ...
      <div v-else class="text-center py-12">
        ...
        <h3 class="text-lg text-gray-900 mb-2">{{ $t('booking.therapistNotFound') }}</h3>
