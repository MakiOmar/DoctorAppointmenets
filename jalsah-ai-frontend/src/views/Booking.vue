  ...
  <div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div class="card sticky top-8">
            ...
            <div class="space-y-4 mb-6">
              <div class="flex justify-between">
                ...
                <span class="font-medium">{{ booking.sessionType || 'Not selected' }} minutes</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Date:</span>
                <span class="font-medium">{{ booking.date || 'Not selected' }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Time:</span>
                <span class="font-medium">{{ booking.time || 'Not selected' }}</span>
              </div>
            </div>
      ...
      <div v-else class="text-center py-12">
        ...
        <p class="text-gray-600">The therapist you're trying to book with doesn't exist or has been removed.</p>
        <button 
