          ...
          <div>
            ...
            <div class="flex" style="direction: ltr;">
              ...
              <input
                ...
                type="tel"
                required
                class="flex-1 px-3 py-3 border border-gray-300 rounded-r-md rounded-l-none border-l-0 focus:outline-none focus:ring-primary-500 focus:border-primary-500 h-12"
