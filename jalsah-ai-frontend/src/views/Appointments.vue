    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        <div class="border border-gray-200 rounded-lg overflow-hidden">
          <!-- Accordion Header -->
          <button
            @click="instructionsAccordionOpen = !instructionsAccordionOpen"
            class="w-full flex items-center justify-between px-6 py-4 bg-primary-500 text-white hover:bg-primary-600 transition-colors"
            :class="locale === 'ar' ? 'flex-row-reverse' : ''"
          >
            <h3 class="text-lg font-medium">{{ $t('session.instructions') }}</h3>
            <svg
              class="w-5 h-5 transition-transform duration-200 flex-shrink-0"
              :class="{ 'rotate-180': instructionsAccordionOpen }"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            <div v-show="instructionsAccordionOpen" class="bg-white">
              <div class="px-6 py-4 space-y-3 text-sm text-gray-700">
                ...
                <div class="flex items-start space-x-2 rtl:space-x-reverse">
                  ...
                  <span>{{ $t('session.instruction4') }}</span>
                </div>
                <div class="flex items-start space-x-2 rtl:space-x-reverse">
                  <svg class="w-4 h-4 text-primary-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                  </svg>
                  <span>{{ $t('session.instruction5') }}</span>
                </div>
                <div class="flex items-start space-x-2 rtl:space-x-reverse">
                  <svg class="w-4 h-4 text-primary-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                  </svg>
                  <span>{{ $t('session.instruction6') }}</span>
                </div>
                <div class="pt-2 border-t border-gray-200">
                  <p class="mb-2">{{ $t('session.instruction7') }}</p>
                  <a
                    :href="$t('session.customerServiceWhatsApp')"
                    target="_blank"
                  ...
                  >
                    ...
                    <span>{{ $t('session.contactWhatsApp') }}</span>
                  </a>
                </div>
              </div>
            </div>
...
export default {
  ...
  setup() {
    ...
    const instructionsAccordionOpen = ref(false)
