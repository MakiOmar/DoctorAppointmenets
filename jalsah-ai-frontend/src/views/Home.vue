      ...
      <div class="max-w-[960px] mx-auto">
        <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div class="flex-shrink-0 flex flex-row md:flex-col gap-4 items-center">
            <!-- Payment Method Icons - Mobile: Left, Desktop: Hidden (shown below globe) -->
            <!-- Visa (Layer-12) - Mobile: First -->
            ...
            <!-- Globe Icon with Payment Icons Below (Desktop) -->
            ...
            <!-- MasterCard (Layer-11) - Mobile: Right, Desktop: Hidden -->
            <div class="flex md:hidden">
              <img 
                v-if="layer11Exists"
                src="/home/Layer-11.png" 
