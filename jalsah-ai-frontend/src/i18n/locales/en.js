export default {
  ...
  manualBooking: {
    ...
    followupTherapist: 'Therapist name',
    followupPatient: 'Patient name',
    followupAppointment: 'Appointment',
    followupDone: 'Done',
    followupWhatsapp: 'Open WhatsApp link',
    followupNoWhatsapp: 'No WhatsApp number',
    followupEmpty: 'No pending follow-ups',
    followupLoadFailed: 'Failed to load follow-ups',
    followupMarkedDone: 'Marked as contacted',
    followupMarkFailed: 'Failed to update',
    followupConfirmDoneTitle: 'Mark as contacted?',
    followupConfirmDoneText: 'Confirm you have communicated with the patient.',
    ...
    manageBookings: 'Manage manual bookings',
    openSlots: 'Open slots',
    noOpenSlots: 'No open slots for this date.',
    selectDateToViewOpenSlots: 'Select a date and click Search to view Jalsah AI open (booked) slots.',
    searchByPhone: 'Search by phone',
    availabilityCopy: 'Available hours copy',
    ...
    typeManual: 'Manual',
    typeAi: 'AI',
    bookingsForTherapist: 'Bookings for this therapist',
    bookingsForPatient: 'Bookings for this patient',
    noBookingsFound: 'No bookings found for this phone.',
    blockIfBeforeNumber: 'Last time available to book a session before removing it from the booking list',
    ...
    tableTherapistPhone: 'Therapist phone',
  ...
  rochtahMeet: {
    ...
    diagnosisPreview: 'Referral diagnosis (from إرسال لروشتا)',
    loadingDiagnosis: 'Loading referral...',
    diagnosisName: 'Initial diagnosis',
    symptoms: 'Symptoms',
    reasoning: 'Reason for referral',
    noDiagnosis: 'No Rochtah referral on file. Booking cannot be created until the therapist submits a referral.',
    hasReferral: 'This patient has a Rochtah referral.',
    referringTherapist: 'Referring therapist',
    cannotSubmitNoReferral: 'Submit is disabled until a referral (إرسال لروشتا) exists.',
    ...
    validation: {
      ...
      referralRequired: 'A therapist Rochtah referral is required before booking',
    ...
    messages: {
      ...
      loadDiagnosisFailed: 'Failed to load Rochtah referral',
  ...
  profile: {
    ...
    searchCountries: 'Search countries...',
    noNeedDialCode: 'Please enter only the number without the country code',
  ...
  therapistDetails: {
    ...
    nearestAvailable: 'Nearest Available Appointment for Booking',
    bookThis: 'Book This',
    bookThisAppointment: 'Book This Appointment',
    bookAnother: 'Book Another Appointment',
    otherAppointments: 'Other Appointments',
    addedToCart: 'Added to Cart',
    canBookMultipleSessions: 'You can book more than one session at the same time',
    allAppointmentsEgyptTime: 'All appointments are in Egypt time',
  ...
  session: {
    ...
    confirmExit: 'Are you sure you want to exit the session?',
    confirmCloseModal: 'Are you sure you want to close the session? This will end your meeting.',
    instructions: 'Session Instructions',
    instruction1: 'Session duration is 45 minutes only.',
    instruction2: 'You can join the session from either mobile or laptop through your appointments page.',
    instruction3: 'You must join the session on time to avoid cancellation.',
    instruction4: 'Please ensure good internet quality before joining the session and sit in a quiet place for the best experience.',
    instruction5: 'When joining the session, the browser will ask for permission to use the microphone and camera, and you must allow this to ensure they work during the session.',
    instruction6: 'If your problem requires medication prescription and the therapist is not authorized to write prescriptions, please ask the therapist during the session to activate the prescription service for you so that you can book a session at a symbolic cost with the site\'s psychiatrist to write and follow up on medications only, in addition to your sessions with the therapist.',
    instruction7: 'For any inquiries, please contact customer service on the following WhatsApp number:',
