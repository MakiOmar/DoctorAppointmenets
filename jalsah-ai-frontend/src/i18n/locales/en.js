export default {
  ...
  nav: {
    ...
    packageSubscriptions: 'Package subscriptions',
    packageSessions: 'Package sessions',
    packageOweReport: 'Package patient owe report',
    extraFeesSessions: 'Extra fees sessions',
  ...
  manualBooking: {
    ...
    connectPackageTab: 'Connect package',
    connectPackageHint: 'Link a patient to a session package with a therapist, price, and payment method.',
    connectPackageSubmit: 'Connect package',
    connectPackageSuccess: 'Package connected',
    connectPackageFailed: 'Failed to connect package',
    connectPackageNeedPatientTherapist: 'Please select patient and therapist',
    packageType: 'Package type',
    packagePrice: 'Package price',
    packageSessionPrice: 'Session price in package',
    sessions: 'sessions',
    packageDetected: 'Patient has an active package with this therapist',
    bookingFromPackage: 'From package',
    bookingNormal: 'Normal booking',
    packageSessionNote: 'This is session {n} of {x}',
    extraFees: 'Extra fees',
    extraFeesPlaceholder: 'Optional',
    extraFeesHint: 'Added to the session price and paid to Jalsah; excluded from therapist commission.',
    tablePackageCounter: 'Package',
  ...
  packages: {
    subscriptionsTitle: 'Package subscriptions',
    sessionsTitle: 'Package sessions',
    oweTitle: 'Patient package owe report',
    oweHint: 'Remaining amount = remaining sessions × package session price.',
    extraFeesTitle: 'Sessions with extra fees',
    extraFeesHint: 'Extra fees are credited to Jalsah and are not added to therapist profit.',
    ...
    cancelConfirmText: 'No automatic refunds. The subscription will be excluded from the owe report.',
    cancelSuccess: 'Subscription cancelled',
    cancelFailed: 'Failed to cancel subscription',
    noSubscriptions: 'No subscriptions.',
    noSessions: 'No package sessions.',
    noOwe: 'No outstanding amounts.',
    noExtraFees: 'No sessions with extra fees in this period.',
    loadFailed: 'Failed to load',
    connectFilter: 'Connect phone + date range filter',
    dateRange: 'Date range',
    sessionsFilterHint: 'Without connect: phone skips date range; no phone uses date range. With connect: phone and date range together.',
    amountPaid: 'Amount paid',
    amountRemaining: 'Amount remaining',
    therapistPrice: 'Therapist price',
    totalExtraFees: 'Total extra fees'
  },
