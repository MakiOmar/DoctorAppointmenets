export default {
  ...
  nav: {
    ...
    packageSubscriptions: 'اشتراكات الباقات',
    packageSessions: 'جلسات الباقات',
    packageOweReport: 'مستحقات المرضى من الباقات',
    extraFeesSessions: 'الرسوم الإضافية',
  ...
  manualBooking: {
    ...
    connectPackageTab: 'ربط باقة',
    connectPackageHint: 'ربط مريض بباقة لجلسات مع معالج محدد، مع تحديد السعر وطريقة الدفع.',
    connectPackageSubmit: 'ربط الباقة',
    connectPackageSuccess: 'تم ربط الباقة',
    connectPackageFailed: 'فشل ربط الباقة',
    connectPackageNeedPatientTherapist: 'يرجى اختيار المريض والمعالج',
    packageType: 'نوع الباقة',
    packagePrice: 'سعر الباقة',
    packageSessionPrice: 'سعر الجلسة داخل الباقة',
    sessions: 'جلسات',
    packageDetected: 'المريض مرتبط بباقة لهذا المعالج',
    bookingFromPackage: 'من الباقة',
    bookingNormal: 'حجز عادي',
    packageSessionNote: 'هذه الجلسة رقم {n} من {x}',
    extraFees: 'رسوم إضافية',
    extraFeesPlaceholder: 'اختياري',
    extraFeesHint: 'تُضاف لسعر الجلسة وتذهب لجلسة، ولا تدخل في عمولة المعالج.',
    tablePackageCounter: 'الباقة',
  ...
  packages: {
    subscriptionsTitle: 'إدارة اشتراكات الباقات',
    sessionsTitle: 'جلسات الباقات',
    oweTitle: 'مستحقات المرضى من الباقات',
    oweHint: 'المبلغ المتبقي = الجلسات المتبقية × سعر الجلسة داخل الباقة.',
    extraFeesTitle: 'جلسات برسوم إضافية',
    extraFeesHint: 'الرسوم الإضافية تُحسب لجلسة ولا تُضاف لربح المعالج.',
    ...
    cancelConfirmText: 'لن يتم استرداد أي مبالغ تلقائياً. الاشتراك لن يظهر في تقرير المستحقات.',
    cancelSuccess: 'تم إلغاء الاشتراك',
    cancelFailed: 'فشل إلغاء الاشتراك',
    noSubscriptions: 'لا توجد اشتراكات.',
    noSessions: 'لا توجد جلسات باقة.',
    noOwe: 'لا توجد مستحقات حالياً.',
    noExtraFees: 'لا توجد جلسات برسوم إضافية في هذه الفترة.',
    loadFailed: 'فشل التحميل',
    connectFilter: 'ربط البحث بالهاتف ونطاق التاريخ',
    dateRange: 'نطاق التاريخ',
    sessionsFilterHint: 'بدون تفعيل الربط: البحث بالهاتف يتجاهل التاريخ، وبدون هاتف يُستخدم نطاق التاريخ. مع التفعيل: البحث بالهاتف والتاريخ معاً.',
    amountPaid: 'المبلغ المدفوع',
    amountRemaining: 'المبلغ المتبقي',
    therapistPrice: 'سعر المعالج',
    totalExtraFees: 'إجمالي الرسوم الإضافية'
  },
