export default {
  ...
  chatDiagnosis: {
    ...
    welcome: {
      ...
      message: 'مرحباً! أنا مساعدك الذكي للصحة النفسية. أنا هنا لمساعدتك في فهم ما تمر به واقتراح أفضل نوع من العلاج لك. يرجى إخباري عن وضعك الحالي أو الأعراض أو المخاوف التي لديك. يمكنك أن تكون مفصلاً كما تريد - أنا هنا للاستماع والمساعدة.'
    },
    input: {
